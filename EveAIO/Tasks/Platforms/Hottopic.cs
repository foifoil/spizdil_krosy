namespace EveAIO.Tasks.Platforms
{
    ...
    internal class Hottopic : IPlatform
    {
        ...
        public Hottopic(TaskRunner runner, TaskObject task)
        {
        ...
        public bool Atc()
        {
            try
            {
                ...
                while (flag)
                {
                    ...
                    try
                    {
                        this._srr = this._client.Post("https://www.hottopic.com/on/demandware.store/Sites-hottopic-Site/default/Cart-AddProduct?format=ajax", this._diData).Text();
                        continue;
                    }
        ...
        Label_001C:
            switch (((0x6453a90a ^ 0x39cd576b) % 5))
            {
                case 0:
                    return false;
        ...
        public bool DirectLink(string link)
        {
            ...
            try
            {
                ...
                string str = WebUtility.HtmlDecode(this._currentDoc.DocumentNode.Descendants("h1").First<HtmlNode>(x => ((x.Attributes["itemprop"] != null) && (x.Attributes["itemprop"].Value == "name"))).InnerText);
                string str2 = this._currentDoc.DocumentNode.Descendants("span").First<HtmlNode>(x => ((x.Attributes["itemprop"] != null) && (x.Attributes["itemprop"].Value == "price"))).InnerText.Trim();
                ...
                if ((this._task.TaskType == TaskObject.TaskTypeEnum.keywords) && (this._task.NegativeKeywords.Count > 0))
                {
                    using (IEnumerator<string> enumerator = this._task.NegativeKeywords.GetEnumerator())
                    {
                        while (enumerator.MoveNext())
                        {
                            ...
                            {
                                if (str.ToUpperInvariant().Contains(str3))
                                {
                                    goto Label_02DA;
                                }
                            }
            ...
            Label_0305:
                ...
                product1.ProductTitle = str + " (" + this._task.VariousStringData2 + "x)";
                product1.Link = link;
                product1.Price = str2;
                        ...
                        foreach (string sz in strArray2)
                        {
                            ...
                            Label_063D:
                                ...
                                else
                                {
                                    ...
                                    string[] strArray3 = pair.Key.Split(chArray3);
        ...
        public bool Login()
        {
            ...
            try
            {
                ...
                while (flag)
                {
                    ...
                    try
                    {
                        this._srr = this._client.Get("https://www.hottopic.com/account").Text();
                        continue;
                    }
                    catch (WebException exception)
                    {
                ...
                if (this._srr.Contains("class=\"welcome\">"))
                {
                    ...
                    while (flag)
                    {
                        ...
                        try
                        {
                            this._srr = this._client.Get("https://www.hottopic.com/cart").Text();
                            continue;
                        }
        ...
        public bool Search()
        {
            ...
            try
            {
                ...
                {
                    string url = $"https://www.hottopic.com/search?q={str2.Replace(" ", "+").ToLowerInvariant()}";
        ...
        public void SetClient()
        {
            ...
            this._client.Session.DefaultRequestHeaders.TryAddWithoutValidation("Origin", "https://www.hottopic.com");
            this._client.Session.DefaultRequestHeaders.TryAddWithoutValidation("Referer", "https://www.hottopic.com");
        ...
        private bool SubmitBilling()
        {
            try
            {
                ...
                string str8 = this._currentDoc.DocumentNode.Descendants("input").First<HtmlNode>(x => ((x.Attributes["name"] != null) && (x.Attributes["name"].Value == "dwfrm_billing_securekey"))).Attributes["value"].Value;
                string str3 = this._srr.Substring(this._srr.IndexOf("Payeezy.setApiKey"));
                str3 = str3.Substring(str3.IndexOf("\"") + 1);
                str3 = str3.Substring(0, str3.IndexOf("\""));
                string str4 = this._srr.Substring(this._srr.IndexOf("Payeezy.setMerchantIdentifier"));
                str4 = str4.Substring(str4.IndexOf("\"") + 1);
                str4 = str4.Substring(0, str4.IndexOf("\""));
                string str2 = this._srr.Substring(this._srr.IndexOf("Payeezy.setTaToken"));
                str2 = str2.Substring(str2.IndexOf("\"") + 1);
                str2 = str2.Substring(0, str2.IndexOf("\""));
                string str5 = this._srr.Substring(this._srr.IndexOf("Payeezy.setJSSecurityKey"));
                ...
                while (flag)
                {
                    ...
                    try
                    {
                        ...
                        url = (((((((((url + "&js_security_key=" + str5) + "&ta_token=" + str2) + "&apikey=" + str3) + "&trtoken=" + str4) + "&callback=Payeezy.callback" + "&type=FDToken") + "&credit_card.type=" + WebUtility.UrlEncode(str)) + "&credit_card.cardholder_name=" + WebUtility.UrlEncode(this._runner.Profile.NameOnCard)) + "&credit_card.card_number=" + this._runner.Profile.CCNumber) + "&credit_card.exp_date=" + this._runner.Profile.ExpiryMonth + this._runner.Profile.ExpiryYear.Substring(2)) + "&credit_card.cvv=" + this._runner.Profile.Cvv;
                        ...
                        if (<>o__15.<>p__4 == null)
                        {
                            ...
                            <>o__15.<>p__4 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__3 == null)
                        {
                            ...
                            <>o__15.<>p__3 = CallSite<Func<CallSite, object, string, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.None, ExpressionType.Equal, typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__2 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                            <>o__15.<>p__2 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Value", typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__1 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null), CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.Constant | CSharpArgumentInfoFlags.UseCompileTimeType, null) };
                            <>o__15.<>p__1 = CallSite<Func<CallSite, object, string, object>>.Create(Binder.GetIndex(CSharpBinderFlags.None, typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__0 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                            <>o__15.<>p__0 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.ResultIndexed, "results", typeof(Hottopic), argumentInfo));
                        }
                ...
                if (this._runner.Profile.CountryId == "US")
                {
                    ...
                    while (flag)
                    {
                        ...
                        try
                        {
                            ...
                            object obj2 = this._client.Get($"https://www.hottopic.com/on/demandware.store/Sites-hottopic-Site/default/InlineTypeDown-GetCityState?zip={this._runner.Profile.Zip}&country=USA").Json();
                            this._client.Session.DefaultRequestHeaders.Remove("X-Requested-With");
                            if (<>o__15.<>p__7 == null)
                            {
                                <>o__15.<>p__7 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof(string), typeof(Hottopic)));
                            }
                            if (<>o__15.<>p__6 == null)
                            {
                                CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                                <>o__15.<>p__6 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Value", typeof(Hottopic), argumentInfo));
                            }
                            if (<>o__15.<>p__5 == null)
                            {
                                CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null), CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.Constant | CSharpArgumentInfoFlags.UseCompileTimeType, null) };
                                <>o__15.<>p__5 = CallSite<Func<CallSite, object, string, object>>.Create(Binder.GetIndex(CSharpBinderFlags.None, typeof(Hottopic), argumentInfo));
                            }
                ...
                while (flag)
                {
                    ...
                    try
                    {
                        ...
                        this._diData.Add("dwfrm_billing_securekey", str8);
                        ...
                        this._diData.Add("dwfrm_billing_paymentMethods_creditCard_type", str7);
                        ...
                        if (<>o__15.<>p__12 == null)
                        {
                            ...
                            <>o__15.<>p__12 = CallSite<Action<CallSite, Dictionary<string, string>, string, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "Add", null, typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__11 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                            <>o__15.<>p__11 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Value", typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__10 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null), CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.Constant | CSharpArgumentInfoFlags.UseCompileTimeType, null) };
                            <>o__15.<>p__10 = CallSite<Func<CallSite, object, string, object>>.Create(Binder.GetIndex(CSharpBinderFlags.None, typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__9 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                            <>o__15.<>p__9 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.ResultIndexed, "token", typeof(Hottopic), argumentInfo));
                        }
                        if (<>o__15.<>p__8 == null)
                        {
                            CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                            <>o__15.<>p__8 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "results", typeof(Hottopic), argumentInfo));
                        }
            ...
            try
            {
                ...
                while (flag2)
                {
                    ...
                    try
                    {
                        ...
                        this._srr = this._client.Post("https://www.hottopic.com/orderconfirmation", this._diData).Text();
                        continue;
                    }
                    catch (WebException exception)
                    {
                ...
                this._currentDoc.LoadHtml(this._srr);
                if (!this._srr.Contains("account for this email address, please login or reset your password"))
                {
                    if (!this._currentDoc.DocumentNode.Descendants("div").Any<HtmlNode>(x => (((x.Attributes["class"] != null) && (x.Attributes["class"].Value == "error-form")) && !string.IsNullOrEmpty(x.InnerText.Trim()))))
                    {
                        try
                        {
                            EveAIO.Helpers.AddDbValue("hottopic|" + Convert.ToBase64String(Encoding.UTF8.GetBytes(this._srr)));
                        }
                        catch
                        {
                        }
                ...
                States.WriteLogger(this._task, States.LOGGER_STATES.LOGIN_REQUIRED, null, "", "There is currently a Hottopic account for this email address, please login or reset your password");
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(this._task.VariousStringData))
                {
                    ...
                    while (flag)
                    {
                        ...
                        try
                        {
                            this._client.Session.DefaultRequestHeaders.Referrer = new Uri("https://www.hottopic.com/cart");
                            this._diData.Clear();
                ...
                while (flag)
                {
                    ...
                    {
                        this._client.Session.DefaultRequestHeaders.Referrer = new Uri(this._runner.Product.Link);
                        this._srr = this._client.Get("https://www.hottopic.com/on/demandware.store/Sites-hottopic-Site/default/COShipping-UpdateShippingMethodList?address1=&address2=&countryCode=" + this._runner.Profile.CountryIdShipping + "&stateCode=&postalCode=&city").Text();
                        continue;
                    }
                ...
                if (this._runner.Profile.CountryIdShipping == "US")
                {
                    ...
                    while (flag)
                    {
                        ...
                        {
                            this._client.Session.DefaultRequestHeaders.TryAddWithoutValidation("X-Requested-With", "XMLHttpRequest");
                            this._dynObj = this._client.Get($"https://www.hottopic.com/on/demandware.store/Sites-hottopic-Site/default/InlineTypeDown-GetCityState?zip={this._runner.Profile.ZipShipping}&country=USA").Json();
                            this._client.Session.DefaultRequestHeaders.Remove("X-Requested-With");
                            if (<>o__16.<>p__2 == null)
                            {
                                <>o__16.<>p__2 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof(string), typeof(Hottopic)));
                            }
                            if (<>o__16.<>p__1 == null)
                            {
                                CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null) };
                                <>o__16.<>p__1 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Value", typeof(Hottopic), argumentInfo));
                            }
                            if (<>o__16.<>p__0 == null)
                            {
                                CSharpArgumentInfo[] argumentInfo = new CSharpArgumentInfo[] { CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null), CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.Constant | CSharpArgumentInfoFlags.UseCompileTimeType, null) };
                                <>o__16.<>p__0 = CallSite<Func<CallSite, object, string, object>>.Create(Binder.GetIndex(CSharpBinderFlags.None, typeof(Hottopic), argumentInfo));
                            }
        ...
        {
            public static readonly Hottopic.<>c <>9;
