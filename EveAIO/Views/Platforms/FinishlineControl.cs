namespace EveAIO.Views.Platforms
{
    ...
    public class FinishlineControl : UserControl, IComponentConnector
    {
        ...
        public FinishlineControl(TaskWindow2 taskWindow)
        {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/EveAIO;component/views/platforms/finishlinecontrol.xaml", UriKind.Relative);
